...
#ifndef GPUThread128_H
#define GPUThread128_H
...
class GPUThread_128 :public GPUThread_0, public juce::Thread
{
public:
    GPUThread_128(GPUConvEngine_128* engine) : juce::Thread("GPUThread128"), activeEngine(engine)
    {
        prepare();
...
private:
    ...
    GPUConvEngine_128* activeEngine = nullptr;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(GPUThread_128)
